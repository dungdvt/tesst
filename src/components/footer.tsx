const Footer = () => {
    return <footer className="bg-white">
        <div className="text-center mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8  ">
            <div className="flex justify-center text-teal-900 text-2xl">
                <h1>Công ty TNHH Thương Mại Dịch Vụ Vexere</h1>
            </div>
            ...
            <p className=" space-y-8">
                ...
                Bản quyền © 2020 thuộc về Vexere.Com
            </p>
